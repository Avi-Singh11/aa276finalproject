"""Torch-native BRT training entry point for the 10D coffee arm model."""
...
from BRT_TORCH_NATIVE_preflight import run_preflight
...
CFG = dict(
    ...
    hidden_features=256,
    num_hidden_layers=3,
    save_dir='BRT_TORCH_NATIVE_model',
...
CFG_FAST = {
    **CFG,
    ...
    'counter_end':      25_000,   
    'save_dir':         'BRT_TORCH_NATIVE_model_fast',
}
...
CFG_BENCHMARK = {
    **CFG,
    ...
    'counter_end':        20,
    'save_dir':           'BRT_TORCH_NATIVE_benchmark',
    'log_every':          5,
}
...
CFG_PILOT = {
    **CFG,
    ...
    'save_dir':           'BRT_TORCH_NATIVE_model_pilot',
    'log_every':          250,
}
...
def train_brt(cfg=CFG, model=None, dynamics=None):
    ...
    if dynamics is None:
        dynamics = BRTTorchNativeCoffeeArmDynamics()
...
if __name__ == '__main__':
    ...
    if args.test:
        ...
        dyn = BRTTorchNativeCoffeeArmDynamics()
