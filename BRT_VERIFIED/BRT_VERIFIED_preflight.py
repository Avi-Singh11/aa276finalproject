"""Fast correctness gate for the separate verified BRT pipeline."""
...
def run_preflight(dynamics, n_tests=64, seed=7, verbose=False):
    ...
    probe = rng.uniform(-0.5, 0.5, (128, 10)) * scale
    vectorized = np.asarray(dynamics.boundary_fn(probe))
    ...
    if verbose:
        print("BRT_VERIFIED preflight passed")
...
if __name__ == "__main__":
    ...
    run_preflight(BRTVerifiedCoffeeArmDynamics(), verbose=True)
