"""Torch-native dynamics for the separate BRT_TORCH_NATIVE pipeline."""
...
class BRTTorchNativeCoffeeArmDynamics:
    ...
    def boundary_fn(self, coord):
        """Torch-native normalized safety margin, preserving device and dtype."""
