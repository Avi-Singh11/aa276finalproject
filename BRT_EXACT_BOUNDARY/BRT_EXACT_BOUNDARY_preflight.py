"""Correctness and equivalence gate for BRT_EXACT_BOUNDARY."""
...
def run_preflight(dynamics, n_tests=64, seed=7, verbose=False):
    ...
    if verbose:
        print("BRT_EXACT_BOUNDARY preflight passed")
...
if __name__ == "__main__":
    ...
    run_preflight(BRTExactBoundaryCoffeeArmDynamics(), verbose=True)
