"""Exact-boundary dynamics for the separate BRT_EXACT_BOUNDARY pipeline."""
...
class BRTExactBoundaryCoffeeArmDynamics:
    ...
    def boundary_fn(self, coord):
        """Exact-boundary normalized safety margin, preserving device and dtype."""
