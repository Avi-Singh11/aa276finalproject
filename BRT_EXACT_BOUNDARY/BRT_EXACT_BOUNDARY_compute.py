"""Exact-boundary BRT training entry point for the 10D coffee arm model."""
...
from BRT_EXACT_BOUNDARY_dynamics import BRTExactBoundaryCoffeeArmDynamics
from BRT_EXACT_BOUNDARY_preflight import run_preflight
...
CFG = dict(
    ...
    hidden_features=256,
    num_hidden_layers=3,
    save_dir='BRT_EXACT_BOUNDARY_model',
...
CFG_FAST = {
    **CFG,
    ...
    'counter_end':      25_000,   
    'save_dir':         'BRT_EXACT_BOUNDARY_model_fast',
}
...
CFG_BENCHMARK = {
    **CFG,
    ...
    'counter_end':        20,
    'save_dir':           'BRT_EXACT_BOUNDARY_benchmark',
    'log_every':          5,
}
...
CFG_PILOT = {
    **CFG,
    ...
    'save_dir':           'BRT_EXACT_BOUNDARY_model_pilot',
    'log_every':          250,
}
...
def train_brt(cfg=CFG, model=None, dynamics=None):
    ...
    if dynamics is None:
        dynamics = BRTExactBoundaryCoffeeArmDynamics()
    ...
    for epoch in tqdm(range(cfg['epochs']), desc='BRT training'):
        ...
        if (epoch + 1) % log_every == 0:
            ...
            tqdm.write(
                ...
                f"equilibrium={equilibrium_loss.item():.5f}  V_std={v_std:.5f}"
            )
...
if __name__ == '__main__':
    ...
    if args.test:
        ...
        dyn = BRTExactBoundaryCoffeeArmDynamics()
